<template>
  <div class="secret-container">
    <!-- 导航栏 -->
    <NavBar v-if="h5" :config="navBarConfig" />
    <main>
      <p class="P10">
        <span class="T1">隐私政策</span>
      </p>
      <p class="P6">
        本政策仅适用于
        <span class="T2">本公司</span>的产品或服务。 最近更新日期：
        <span class="T2">2021年8月18日</span>
      </p>
      <p class="P6">
        本政策将帮助您了解以下内容：
      </p>
      ...
      <p class="P6">
        在您使用我们的服务时，允许我们收集您自行向我们提供的或为向您提供服务所必要的信息包括：网络日志、设备信息、
        <span class="T2">通信信息、</span>位置信息和其它相关信息等。
      </p>
      <p class="P7">
      ...
      <p class="P7">
        ...
        通常包含标识符、站点名称以及一些号码和字符。借助于 Cookie，网站能够存储您的访问偏好数据。
      </p>
      <p class="P7">
      ...
      <ol>
        <li>
          <p class="P8" style="margin-left:0cm;">
            <span style="display:block;float:left;min-width:NaNcm;">（七）</span>
            <span class="T2">网络</span
            >环境并非百分之百安全，我们将尽力确保您发送给我们的任何信息的安全性。即使我们做出了很大努力，采取了一切合理且必要的措施，仍然有可能无法杜绝您的用户信息被非法访问、被非法盗取，被非法篡改或毁坏，导致您的合法权益受损，请您理解信息网络的上述风险并自愿承担。
            <span class="odfLiEnd" />
          </p>
        </li>
        <li>
          <p class="P8" style="margin-left:0cm;">
            <span style="display:block;float:left;min-width:NaNcm;">（八）</span
      ...
      <p class="P7"><a id="（二）更正您的用户信息" />（二）更正您的用户信息</p>
      <p class="P7">
        当您发现我们处理的关于您的用户信息有错误时，您有权要求我们作出更正。
      </p>
      <p class="P7" />
      <p class="P7">
        （三）删除您的用户信息
      ...
      <p class="P7">
        <a id="（四）改变您授权同意的范围" />
        <span class="T6">（四）改变您授权同意的范围</span>
      </p>
      <p class="P7">
        <span class="T6"
          >每个业务功能需要一些基本的用户信息才能得以完成（见本政策“第一部分”）。对于用户信息的收集和使用，您可以随时给予或收回您的授权同意。</span
        >
      </p>
      <p class="P7">
        <span class="T6"
      ...
      <p class="P9" />
      <p class="P7">
        <span class="T6">（五）用户信息主体注销账户</span>
      </p>
      <p class="P7">
        <span class="T6"
          >您随时可注销此前注册的账户，在注销账户之后，我们将停止为您提供产品或服务并依据您的要求，删除或匿名化您的信息，法律法规另有规定的除外。这也将可能导致您失去对您账户中数据的访问权，请您谨慎操作。</span
        >
      </p>
      <p class="P9" />
      <p class="P7">
        <span class="T6">（六）用户信息主体获取用户信息副本</span>
      </p>
      <p class="P7">
        <span class="T6"
          >您有权获取您的用户信息副本，在技术可行的前提下，例如数据接口匹配，我们还可按您的要求，直接将您的用户信息副本传输给您指定的第三方。</span
        >
      </p>
      <p class="P9" />
      <p class="P7">
        <span class="T6">（七）约束信息系统自动决策</span>
      </p>
      <p class="P7">
        <span class="T6"
      ...
      <p class="P7">
        <span class="T6">1、与用户信息控制者履行法律法规规定的义务相关的；</span>
      </p>
      <p class="P7">
        <span class="T6">2、与国家安全、国防安全直接相关的；</span>
      </p>
      <p class="P7">
        <span class="T6">3、与公共安全、公共卫生、重大公共利益直接相关的；</span>
      </p>
      <p class="P7">
        <span class="T6">4、与犯罪侦查、起诉、审判和执行判决等直接相关的；</span>
      </p>
      <p class="P7">
        <span class="T6"
      ...
      <p class="P7">
        <span class="T6">8、涉及商业秘密的。</span>
        <a id="六、我们如何处理儿童的个人信息" />
      </p>
      <p class="P9" />
      <p class="P7 title">
        六、本政策如何更新
      ...
      <p class="P7">
        <span class="T3">1</span>
        <span class="T6"
          >、我们在所有权结构、组织架构等方面发生重大变化。如业务调整、破产并购等引起的所有者变更等；</span
        >
      </p>
      <p class="P7">
        <span class="T3">2</span>
        <span class="T6">、用户信息共享、转让或公开披露的主要对象发生变化；</span>
      </p>
      <p class="P7">
        <span class="T3">3</span>
        <span class="T6">、您参与用户信息处理方面的权利及其行使方式发生重大变化；</span>
      </p>
      <p class="P7">
        <span class="T3">4</span>
        <span class="T6">、我们负责处理用户信息安全的责任部门、联络方式及投诉渠道发生变化时；</span>
      </p>
      <p class="P7">
        <span class="T3">5</span>
        <span class="T6">、用户信息安全影响评估报告表明存在高风险时。</span>
      </p>
      <p class="P7">
        <span class="T6">我们还会将本政策的旧版本存档，供您查阅。</span>
      </p>
      <p class="P5" />
      <p class="P9" />
      <p class="Standard" />
...
export default defineComponent({
  ...
  setup() {
    ...
    // 事件Id
    const h5: any = ref(router.currentRoute.value.query.h5 || '');
