<template>
  ...
  >
    ...
    <main>
      <slot name="list">
        <ul class="visualization-right-expand__default-list">
          <li
          ...
          >
            ...
            <div
              v-if="showSort"
              class="visualization-right-expand__default-list__sort"
            >
              <div
                class="visualization-right-expand__default-list__sort-up"
                @click.stop="upFun(index, list)"
              />
              <div
                class="visualization-right-expand__default-list__sort-down"
                @click.stop="downFun(index, list)"
              />
            </div>
          </li>
        </ul>
...
.visualization-right-expand {
  ...
  & > header {
    ...
    & > i:last-child {
      ...
      width: 12px;
      height: 8px;
      background: no-repeat center/100% 100% url(./assets/arrow.svg);
    }
    &:hover {
      border-color: #56e9ff;
      color: #56e9ff;
