...
SuperMap.Renderer.VML = SuperMap.Class(SuperMap.Renderer.Elements, {
    ...
    /**
     * Constructor: SuperMap.Renderer.VML
...
//        }
    ...
    setStyle: function(node, style, options, geometry) {
        ...
        if ((rotation !== undefined || node._rotation !== undefined)) {
            ...
            if (style.externalGraphic) {
                ...
                // in graphicRotate
                fill.opacity = 0;
            } else if(node._geometryClass === "SuperMap.Geometry.Point") {
     ...
     * Finally, SuperMap methods are used to determine the correct
    ...
    graphicRotate: function(node, xOffset, yOffset, style) {
        ...
        if (!(style.graphicWidth && style.graphicHeight)) {
            ...
            img.onreadystatechange = SuperMap.Function.bind(function() {
        ...
        var centerPoint = new SuperMap.Geometry.Point(-xOffset, -yOffset);
        var imgBox = new SuperMap.Bounds(0, 0, width, height).toGeometry();
    ...
    setNodeDimension: function(node, geometry) {
        ...
        if(bbox) {
            ...
            var scaledBox = 
                new SuperMap.Bounds((bbox.left/resolution - this.offset.x) | 0,
    ...
    createNode: function(type, id) {
        ...
        node.onselectstart = SuperMap.Function.False;
    ...
    drawText: function(featureId, style, location) {
        ...
        var xshift = textbox.clientWidth *
            (SuperMap.Renderer.VML.LABEL_SHIFT[align.substr(0,1)]);
        var yshift = textbox.clientHeight *
            (SuperMap.Renderer.VML.LABEL_SHIFT[align.substr(1,1)]);
        //解决IE7、8下面针对像素设NANpx的异常
    ...
    moveRoot: function(renderer) {
        ...
        if(layer instanceof SuperMap.Layer.Vector.RootContainer) {
