...
SuperMap.Renderer.Canvas2 = SuperMap.Class(SuperMap.Renderer, {
    ...
    restoreCanvas: function(){
        ...
        this.root.setAttribute('crossOrigin', 'anonymous');
        this.hitCanvas.setAttribute('crossOrigin', 'anonymous');
    ...
    drawPolygon: function(geometry, style, featureId) {
        ...
        else
        {
            ...
            if(fill){
                ...
                this.polygonCanvas.setAttribute('crossOrigin', 'anonymous');
    ...
    redraw: function(option) {
        ...
        if(this.lastBounds){
            ...
            this.backCanvas.setAttribute('crossOrigin', 'anonymous');
            this.hitCanvasBack.setAttribute('crossOrigin', 'anonymous');
