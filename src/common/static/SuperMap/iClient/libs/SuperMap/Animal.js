...
SuperMap.Animal = SuperMap.Class({
    ...
    begin: function(canvas, layerAniCanvas, lefttop, ratio, duration, callback) {
        ...
        this.backupCanvas.setAttribute('crossOrigin', 'anonymous');
        try {
            layerAniCanvas.setAttribute('crossOrigin', 'anonymous');
    ...
    execZoomTo: function(callback) {
        ...
        if (elapsed > this.duration) {
            ...
            me.backupCanvas.setAttribute('crossOrigin', 'anonymous');
