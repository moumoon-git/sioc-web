/*
 * @Author: your name
 * @Date: 2021-03-16 13:24:12
 * @LastEditTime: 2021-03-29 15:21:57
 * @LastEditors: your name
 * @Description: In User Settings Edit
 * @FilePath: \sinvie-3\src\common\static\SuperMap\supMap\iClient\libs\SuperMap\Animal2.js
 */
 ...
 * 未经许可，不得以任何手段擅自使用或传播。*/
 ...
 SuperMap.Animal2 = SuperMap.Class(SuperMap.Animal, {
    ...
    initialize: function(layer) {
        SuperMap.Animal.prototype.initialize.apply(this, arguments);
        this.layer = layer;
    ...
    begin: function(canvas, lefttop, callback) {
        ...
        this.baseCanvas.setAttribute('crossOrigin', 'anonymous');
