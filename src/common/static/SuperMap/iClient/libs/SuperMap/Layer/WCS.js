...
SuperMap.Layer.WCS = SuperMap.Class(SuperMap.CanvasLayer, {
    ...
    /**
    * Constructor: SuperMap.Layer.WCS
    * WCS服务图层类。
    *
     * 例如:
     * (code)
     *  var  url="http://localhost:8090/iserver/services/data-world/wcs111"  ;
     *  var map =new SuperMap.Map("map");
     *  var  wcslayer =new SuperMap.Layer.WCS("wcslayer",url);
    ...
    */
    clone: function (obj) {
        var me = this;
        if (obj == null) {
            obj = new SuperMap.Layer.WCS(me.name, me.url, me.getOptions());
        }
